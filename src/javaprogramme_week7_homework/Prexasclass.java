...
public class Prexasclass {
    ...
    public static void main(String[] args) {
        Prexasclass prexa = new Prexasclass();
        prexa.setFirstName(" ");
        prexa.setLastName(" ");
        prexa.setAge(10);
        System.out.println("full name=" +prexa.getFullname());
        System.out.println("teen=" + prexa.isTeen());

        prexa.setFirstName("John");
        prexa.setAge(18);
        System.out.println("full name=" + prexa.getFullname());
        System.out.println("teen=" + prexa.isTeen());

        prexa.setLastName("Smith");
        System.out.println("full name=" + prexa.getFullname());
    }
}